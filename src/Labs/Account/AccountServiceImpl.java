...
public class AccountServiceImpl implements AccountService {
	...
	//use factory to create Account DAO
	public AccountServiceImpl(String environment){
		accountDAO = AccountCustomerDAOFactory.getAccountDAO(environment); // old code => new AccountDAOImpl();
	}
