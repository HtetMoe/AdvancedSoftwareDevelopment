...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(STR."\{simpleCoffee.getDescription()}, costs $\{simpleCoffee.getCost()}");

        // Add milk to the coffee
        Coffee milkCoffee = new MilkDecorator(simpleCoffee);
        System.out.println(STR."\{milkCoffee.getDescription()}, costs $\{milkCoffee.getCost()}");

        // Add sugar to the milk coffee
        Coffee milkAndSugarCoffee = new SugarDecorator(milkCoffee);
        System.out.println(STR."\{milkAndSugarCoffee.getDescription()}, costs $\{milkAndSugarCoffee.getCost()}");
    }
}
/*
